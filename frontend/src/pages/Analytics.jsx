...
import { getInformation , getAnalytics } from "@/api/auth"; // Assuming you have an endpoint for match analytics
import { 
  BarChart2, 
  CheckCircle2, 
  Clock, 
  ...
  if (loading || !analyticsData) {
    return (
      <div className="flex w-full h-screen bg-[#0f0f0f] items-center justify-center text-gray-400 font-sans">
        ...
        <span className="text-sm font-medium tracking-wide">Analyzing Match Data...</span>
      </div>
    );
  }

  const { you, opponent, chartData, questionsBreakdown } = analyticsData;
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between bg-[#18181b] border border-[#27272a] rounded-2xl p-8 relative overflow-hidden">
          ...
          <div className="flex items-center gap-6 z-10">
            <div className={`p-4 rounded-full ${isWinner ? 'bg-yellow-500/10 text-yellow-500' : 'bg-gray-800 text-gray-400'}`}>
          ...
          <div className="flex gap-12 mt-6 md:mt-0 z-10">
            <div className="text-center">
              <p className="text-xs text-gray-500 uppercase tracking-widest font-semibold mb-1">Your Score</p>
              <p className="text-4xl font-mono font-bold text-white">{you.score}</p>
            </div>
            <div className="w-px bg-[#27272a]"></div>
            <div className="text-center">
              <p className="text-xs text-gray-500 uppercase tracking-widest font-semibold mb-1">Opponent</p>
              <p className="text-4xl font-mono font-bold text-gray-500">{opponent.score}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#18181b] border border-[#27272a] rounded-2xl p-6 flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-xl font-bold text-gray-500">{opponent.accuracy}%</p>
            </div>
          </div>
          ...
          <div className="bg-[#18181b] border border-[#27272a] rounded-2xl p-6 flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-sm text-gray-500 mb-1">Opponent</p>
              <p className="text-xl font-bold text-gray-500">{opponent.avgTime}s</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#18181b] border border-[#27272a] rounded-2xl p-6 md:p-8">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-xl font-bold text-white">Submission Time Comparison</h2>
          </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={chartData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                ...
                <Line 
                  ...
                  activeDot={{ r: 6, fill: 'var(--c4, #f97316)', stroke: '#fff' }}
                />
                <Line 
                  type="monotone" 
                  name="Opponent" 
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-[#0f0f0f] p-3 rounded-lg border border-[#27272a]">
                        ...
                        <p className={`font-mono text-sm flex items-center gap-2 ${q.isCorrect ? 'text-green-400' : 'text-red-400'}`}>
                      ...
                      <div className="bg-[#0f0f0f] p-3 rounded-lg border border-[#27272a]">
                        <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Correct Answer</p>
                  ...
                  <div className="md:text-right flex items-center md:flex-col justify-between md:justify-start gap-2">
                    <div className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border ${
                      q.isCorrect ? 'text-green-400 border-green-900/50 bg-green-900/10' : 'text-red-400 border-red-900/50 bg-red-900/10'
                    }`}>
